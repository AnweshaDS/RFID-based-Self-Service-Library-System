<x-guest-layout>
    <h1 class="font-display text-3xl text-ink-navy">Create your account</h1>
    <p class="mt-2 text-sm text-slate">Register for the KUET Library system.</p>
    ...
    <div class="my-6 flex items-center gap-3">
        ...
        <span class="text-xs text-slate">or register with email</span>
        <span class="h-px flex-1 bg-slate/20"></span>
    </div>
    ...
    <p class="mt-6 text-center text-sm text-slate">
        Already registered?
        <a href="{{ route('login') }}" class="font-medium text-catalog-teal hover:underline">Log in</a>
    </p>
</x-guest-layout>